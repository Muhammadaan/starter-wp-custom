...
<head>
    ...
    <!-- Plugin CSS -->
    <link href="<?php echo esc_url( get_template_directory_uri() ); ?>/vendor/magnific-popup/magnific-popup.css" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/creative.min.css" rel="stylesheet">
